...
class AG(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for idx, name in enumerate(frame_names):
            ...
            im, im_scale = prep_im_for_blob(im, [[[123.675, 116.28, 103.53]]], 360, 640)
        ...
        # img_tensor=torch.zeros(8,3,360,640)
        # index = 1
        # obj = torch.zeros(8,37)

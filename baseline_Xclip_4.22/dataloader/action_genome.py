...
class AG(data.Dataset):
    def __init__(self, image_dir, anno_path, mode, datasize, input_transform=None, 
        ...
        with open(os.path.join(root_path, 'annotations/object_classes.txt'), 'r') as f:
            ...
            #     if i in {1, 3, 7, 8, 9,10,12,14,16,18,23,31}: 
            #         line = line.strip('\n')
            #         self.object_classes.append(line)
        f.close()
        ...
        # self.object_classes[4] = 'closet/cabinet'
        # self.object_classes[11] = 'phone/camera'
        # self.object_classes[6] = 'cup/glass/bottle'
# collect relationship classes
        ...
        # index = [4249,3709,4838,6216,6576,4423,2204,2817,340,1056]
    def __getitem__(self, index):
        ...
        img_tensor = torch.cat(new_tensor_list,dim=0)
        return img_tensor, index, obj
